import "./chunk-KWMFLKJJ.js";
import "./chunk-4DW6JFBF.js";
import "./chunk-TVM4OPJZ.js";
import {
  firebase
} from "./chunk-XKHFAMYB.js";
import "./chunk-WIU4UN7G.js";
import {
  __commonJS,
  __toESM,
  init_buffer,
  init_process
} from "./chunk-TVUDBOJX.js";
...
(function() {
  (function() {
    ...
    }, ia = "undefined" != typeof window && window === this ? this : "undefined" != typeof globalThis && null != globalThis ? globalThis : this;
    function ja(a, b) {
      if (b) {
        var c = ia;
        a = a.split(".");
    ...
    }, Wa = /&/g, Xa = /</g, Ya = />/g, Za = /"/g, $a = /'/g, ab = /\x00/g, bb = /[\x00&<>"']/;
    function cb(a, b) {
    ...
    var ib = "StopIteration" in n ? n.StopIteration : { message: "StopIteration", stack: "" };
    function jb() {
    }
    ...
    function ob(a) {
      ...
      if (a.h != a.a.length) {
        ...
        for (c = b = 0; b < a.a.length; )
          d = a.a[b], pb(e, d) || (a.a[c++] = d, e[d] = 1), b++;
        a.a.length = c;
      }
    }
    l.get = function(a, b) {
      return pb(this.g, a) ? this.g[a] : b;
    };
    l.set = function(a, b) {
    ...
    l.ha = function(a) {
      ob(this);
      var b = 0, c = this.j, d = this, e = new jb();
      e.next = function() {
        if (c != d.j)
    ...
    var tb = /#|$/;
    function ub(a, b) {
      var c = a.search(tb), d = sb(a, 0, b, c);
      if (0 > d)
        return null;
      var e = a.indexOf("&", d);
      if (0 > e || e > c)
    ...
    function wb(a, b) {
      ...
      this.i = false;
      var c;
      a instanceof wb ? (this.i = ka(b) ? b : a.i, xb(this, a.j), this.A = a.A, this.h = a.h, yb(this, a.C), this.g = a.g, zb(this, Ab(a.a)), this.s = a.s) : a && (c = String(a).match(qb)) ? (this.i = !!b, xb(this, c[1] || "", true), this.A = Bb(c[2] || ""), this.h = Bb(c[3] || "", true), yb(this, c[4]), this.g = Bb(c[5] || "", true), zb(this, c[6] || "", true), this.s = Bb(c[7] || "")) : (this.i = !!b, this.a = new Cb(null, this.i));
    }
    wb.prototype.toString = function() {
      ...
      var c = this.h;
      if (c || "file" == b)
        a.push("//"), (b = this.A) && a.push(Db(b, Eb, true), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.C, null != c && a.push(":", String(c));
      if (c = this.g)
        this.h && "/" != c.charAt(0) && a.push("/"), a.push(Db(c, "/" == c.charAt(0) ? Fb : Gb, true));
    ...
    l.la = function(a) {
      ...
      var b = [];
      if (q(a))
        Pb(this, a) && (b = Ra(b, this.a.get(Nb(this, a))));
      else {
        a = this.a.la();
        for (var c = 0; c < a.length; c++)
          b = Ra(b, a[c]);
    ...
    var bc = y("Opera"), z = y("Trident") || y("MSIE"), cc = y("Edge"), dc = cc || z, ec = y("Gecko") && !(-1 != Vb.toLowerCase().indexOf("webkit") && !y("Edge")) && !(y("Trident") || y("MSIE")) && !y("Edge"), fc = -1 != Vb.toLowerCase().indexOf("webkit") && !y("Edge"), gc = fc && y("Mobile"), hc = y("Macintosh");
    function ic() {
      var a = n.document;
    ...
    function vc(a) {
      if (a instanceof tc && a.constructor === tc && a.h === uc)
        return a.a;
    ...
    function Ac(a) {
      if (a instanceof yc && a.constructor === yc && a.h === zc)
        return a.a;
    ...
    function Jc(a) {
      if (a instanceof Hc && a.constructor === Hc && a.j === Ic)
        return a.a;
    ...
    var dd = { Fc: true }, ed = { Hc: true }, fd = { Ec: true }, gd = { Gc: true };
    function hd() {
    ...
    var nd = /^<(body|caption|col|colgroup|head|html|tr|td|th|tbody|thead|tfoot)>/i, jd = {};
    function od(a) {
      if (null != a)
        switch (a.va) {
          case 1:
    ...
    function Ed(a) {
      null != a && a.fa === fd ? a = a.content : null == a ? a = "" : a instanceof Fc ? a instanceof Fc && a.constructor === Fc && a.g === Gc ? a = a.a : (Fa("expected object of type SafeStyle, got '" + a + "' of type " + pa(a)), a = "type_error:SafeStyle") : (a = String(a), Fd.test(a) || (Fa(
        "Bad value `%s` for |filterCssValue",
        [a]
      ), a = "zSoyz"));
      return a;
    }
    ...
    var yd = /[\x00\x22\x27\x3c\x3e]/g, Bd = /[\x00- \x22\x27-\x29\x3c\x3e\\\x7b\x7d\x7f\x85\xa0\u2028\u2029\uff01\uff03\uff04\uff06-\uff0c\uff0f\uff1a\uff1b\uff1d\uff1f\uff20\uff3b\uff3d]/g, Fd = /^(?!-*(?:expression|(?:moz-)?binding))(?:[.#]?-?(?:[_a-z0-9-]+)(?:-[_a-z0-9-]+)*-?|-?(?:[0-9]+(?:\.[0-9]*)?|\.[0-9]+)(?:[a-z]{1,2}|%)?|!important|)$/i, Dd = /^(?![^#?]*\/(?:\.|%2E){2}(?:[\/?#]|$))(?:(?:https?|mailto):|[^&:\/?#]*(?:[\/?#]|$))/i, wd = /<(?:!|\/?([a-zA-Z][a-zA-Z0-9:\-]*))(?:[^>'"]|"[^"]*"|'[^']*')*>/g, xd = /</g;
    function Id() {
    ...
    var Rd = 0, Sd = {};
    Qd.prototype.T = false;
    Qd.prototype.o = function() {
      if (!this.T && (this.T = true, this.m(), 0 != Rd)) {
        var a = this[ua] || (this[ua] = ++va);
        if (0 != Rd && this.C && 0 < this.C.length)
    ...
    var Wd = !z || 9 <= Number(oc), Xd = z && !nc("9"), Yd = function() {
      ...
      try {
        n.addEventListener("test", na, b), n.removeEventListener(
          "test",
          na,
          b
        );
    ...
    $d.prototype.preventDefault = function() {
      ...
      if (a.preventDefault)
        a.preventDefault();
      else if (a.returnValue = false, Xd)
        try {
    ...
    var be = "closure_listenable_" + (1e6 * Math.random() | 0), ce = 0;
    ...
    fe.prototype.add = function(a, b, c, d, e) {
      ...
      a || (a = this.a[f] = [], this.g++);
      var g = ge(a, b, d, e);
      -1 < g ? (b = a[g], c || (b.Ia = false)) : (b = new de(b, this.src, f, !!d, e), b.Ia = c, a.push(b));
      return b;
    };
    function he(a, b) {
      var c = b.type;
    ...
    var ie = "closure_lm_" + (1e6 * Math.random() | 0), je = {}, ke = 0;
    function le(a, b, c, d, e) {
      ...
      c = ne(c);
      return a && a[be] ? a.J.add(String(b), c, false, ta(d) ? !!d.capture : !!d, e) : oe(a, b, c, false, d, e);
    }
    function oe(a, b, c, d, e, f) {
      if (!b)
        throw Error("Invalid event type");
      var g = ta(e) ? !!e.capture : !!e, h = pe(a);
      h || (a[ie] = h = new fe(a));
      c = h.add(b, c, d, g, f);
      if (c.proxy)
        return c;
      ...
      if (a.addEventListener)
        Yd || (e = g), void 0 === e && (e = false), a.addEventListener(b.toString(), d, e);
    ...
    function me(a, b, c, d, e) {
      ...
      c = ne(c);
      return a && a[be] ? a.J.add(String(b), c, true, ta(d) ? !!d.capture : !!d, e) : oe(a, b, c, true, d, e);
    }
    function te(a, b, c, d, e) {
      if (qa(b))
        ...
        (d = ta(d) ? !!d.capture : !!d, c = ne(c), a && a[be]) ? (a = a.J, b = String(b).toString(), b in a.a && (f = a.a[b], c = ge(f, c, d, e), -1 < c && (ee(f[c]), Oa(f, c), 0 == f.length && (delete a.a[b], a.g--)))) : a && (a = pe(a)) && (b = a.a[b.toString()], a = -1, b && (a = ge(b, c, d, e)), (c = -1 < a ? b[a] : null) && ue(c));
    }
    function ue(a) {
      ...
      if (a = pe(a)) {
        if (b = a.a[b.toString()])
          for (b = b.concat(), a = 0; a < b.length; a++) {
            var f = b[a];
            f && f.capture == c && !f.sa && (f = we(f, d), e = e && false !== f);
          }
      }
      return e;
    }
      ...
      if (!Wd) {
        ...
        if (!(0 > d.keyCode || void 0 != d.returnValue)) {
          ...
          for (e = d.length - 1; !b.h && 0 <= e; e--) {
            b.g = d[e];
            var f = ve(d[e], a, true, b);
            c = c && f;
          }
          for (e = 0; !b.h && e < d.length; e++)
            b.g = d[e], f = ve(d[e], a, false, b), c = c && f;
        }
        return c;
      }
    ...
    function ye(a, b) {
      ...
      b.h || (g = b.g = a, e = ze(g, d, true, b) && e, b.h || (e = ze(g, d, false, b) && e));
      if (c)
        for (f = 0; !b.h && f < c.length; f++)
          g = b.g = c[f], e = ze(g, d, false, b) && e;
      return e;
    }
    ...
    We.prototype.$goog_Thenable = true;
    l = We.prototype;
    l.fc = function(a, b) {
      a = df(a, a, b);
      a.h = true;
    ...
    function qf(a, b, c) {
      ...
      var f = e.join(",");
      (y("iPhone") && !y("iPod") && !y("iPad") || y("iPad") || y("iPod")) && c.navigator && c.navigator.standalone && a && "_self" != a ? (f = c.document.createElement("A"), d = d instanceof yc ? d : Ec(d), f.href = Ac(d), f.setAttribute("target", a), b.noreferrer && f.setAttribute("rel", "noreferrer"), b = document.createEvent("MouseEvent"), b.initMouseEvent("click", true, true, c, 1), f.dispatchEvent(b), c = {}) : b.noreferrer ? (c = c.open("", a, f), b = Ac(d).toString(), c && (dc && -1 != b.indexOf(";") && (b = "'" + b.replace(/'/g, "%27") + "'"), c.opener = null, b = Kc('<meta name="referrer" content="no-referrer"><meta http-equiv="refresh" content="0; url=' + db(b) + '">', null), c.document.write(Jc(b)), c.document.close())) : (c = c.open(
        Ac(d).toString(),
        a,
        f
    ...
    function sf(a) {
      qf(a, { target: window.cordova && window.cordova.InAppBrowser ? "_system" : "_blank" }, void 0);
    }
    function tf(a, b) {
    ...
    yf.prototype.cancel = function(a) {
      if (this.a)
        this.h instanceof yf && this.h.cancel();
      else {
        if (this.g) {
          var b = this.g;
          delete this.g;
        ...
        this.a || (a = new Af(this), Bf(this), Cf(this, false, a));
      }
    };
    ...
    yf.prototype.then = function(a, b, c) {
      var d, e, f = new We(function(g, h) {
        d = g;
        e = h;
      });
      Ff(this, d, function(g) {
        g instanceof Af ? f.cancel() : e(g);
      });
      return f.then(a, b, c);
    };
    yf.prototype.$goog_Thenable = true;
    function Gf(a) {
      ...
      for (var d = c = false; a.s.length && !a.A; ) {
        ...
        if (f = a.j ? g : f)
          try {
            ...
            if (Ge(b) || "function" === typeof n.Promise && b instanceof n.Promise)
              d = true, a.A = true;
          } catch (k) {
            b = k, a.j = true, Gf(a) || (c = true);
          }
      }
      a.h = b;
      d && (h = t(a.L, a, true), d = t(a.L, a, false), b instanceof yf ? (Ff(b, h, d), b.l = true) : b.then(h, d));
    ...
    var Hf = {};
    function Jf(a) {
      var b = {}, c = b.document || document, d = vc(a).toString(), e = document.createElement("SCRIPT"), f = { rb: e, sb: void 0 }, g = new yf(f), h = null, k = null != b.timeout ? b.timeout : 5e3;
      ...
      e.onload = e.onreadystatechange = function() {
        e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (Kf(e, b.xc || false, h), g.callback(null));
      };
      e.onerror = function() {
        Kf(e, true, h);
    ...
    function zf() {
      if (this && this.rb) {
        var a = this.rb;
        a && "SCRIPT" == a.tagName && Kf(a, true, this.sb);
      }
    }
    function Kf(a, b, c) {
    ...
    Sf.prototype.load = function() {
      ...
      if (this.a)
        return this.a;
      var b = wc();
      return Pf() ? F() : this.a = vf().then(function() {
        if (!Pf())
    ...
    var Yf = new Xf("SEVERE", 1e3), Zf = new Xf("WARNING", 900), $f = new Xf("CONFIG", 700);
    function ag(a) {
      if (a.j)
        return a.j;
      if (a.g)
    ...
    Wf.prototype.log = function(a, b, c) {
      if (a.value >= ag(this).value)
        for (sa(b) && (b = b()), a = new Uf(a, String(b), this.s), c && (a.a = c), c = this; c; ) {
          var d = c, e = a;
          if (d.a)
    ...
    function lg(a, b) {
      ...
      if (a.g) {
        var d = new Date(b.h);
        c.push("[", ig(d.getFullYear() - 2e3) + ig(d.getMonth() + 1) + ig(d.getDate()) + " " + ig(d.getHours()) + ":" + ig(d.getMinutes()) + ":" + ig(d.getSeconds()) + "." + ig(Math.floor(d.getMilliseconds() / 10)), "] ");
      }
    ...
    function wg(a) {
      ...
      for (var b = [], c = [], d, e, f = 0; f < a.length; f++)
        e = Va(a[f]), d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
    ...
    Ag.prototype.set = function(a, b) {
      yg.set(a, b, this.h, this.g, this.a, this.j);
    };
    ...
    function Lg(a, b) {
      for (var c, d = 0; d < Ig; d++)
        for (var e = 0; 4 > e; e++)
          c = 4 * e + d, c = b[c], a.h[d][e] = c;
    }
    function Mg(a) {
      for (var b = [], c = 0; c < Ig; c++)
        for (var d = 0; 4 > d; d++)
          b[4 * d + c] = a.h[c][d];
      return b;
    }
    ...
    function Pg(a) {
      ...
      for (b = 1; 4 > b; b++)
        for (c = 0; 4 > c; c++)
          a.h[b][c] = a.s[b][(c + b) % Ig];
    }
    function Qg(a) {
      for (var b = 1; 4 > b; b++)
        for (var c = 0; 4 > c; c++)
          a.s[b][(c + b) % Ig] = a.h[b][c];
      for (b = 1; 4 > b; b++)
        for (c = 0; 4 > c; c++)
          a.h[b][c] = a.s[b][c];
    }
    ...
    var Rg = [
      ...
      12,
      125
    ], Kg = [[0, 0, 0, 0], [1, 0, 0, 0], [2, 0, 0, 0], [4, 0, 0, 0], [
      8,
      0,
      0,
      0
    ], [16, 0, 0, 0], [32, 0, 0, 0], [64, 0, 0, 0], [128, 0, 0, 0], [27, 0, 0, 0], [54, 0, 0, 0]], Tg = [
      0,
      2,
      4,
      6,
      ...
      for (var c = Ta(b, 0, 16), d = "", e; c.length; ) {
        ...
        for (c = 1; c < e.j; ++c) {
          ...
          for (var g = e.s[0], h = 0; 4 > h; h++)
            g[0] = f[0][h], g[1] = f[1][h], g[2] = f[2][h], g[3] = f[3][h], f[0][h] = Tg[g[0]] ^ Ug[g[1]] ^ g[2] ^ g[3], f[1][h] = g[0] ^ Tg[g[1]] ^ Ug[g[2]] ^ g[3], f[2][h] = g[0] ^ g[1] ^ Tg[g[2]] ^ Ug[g[3]], f[3][h] = Ug[g[0]] ^ g[1] ^ g[2] ^ Tg[g[3]];
          Ng(e, c);
        }
        Og(e, Rg);
        Pg(e);
      ...
      for (b = ""; e.length; ) {
        ...
        for (e = 1; e < d.j; ++e) {
          ...
          for (var f = d.h, g = d.s[0], h = 0; 4 > h; h++)
            g[0] = f[0][h], g[1] = f[1][h], g[2] = f[2][h], g[3] = f[3][h], f[0][h] = Yg[g[0]] ^ Wg[g[1]] ^ Xg[g[2]] ^ Vg[g[3]], f[1][h] = Vg[g[0]] ^ Yg[g[1]] ^ Wg[g[2]] ^ Xg[g[3]], f[2][h] = Xg[g[0]] ^ Vg[g[1]] ^ Yg[g[2]] ^ Wg[g[3]], f[3][h] = Wg[g[0]] ^ Xg[g[1]] ^ Vg[g[2]] ^ Yg[g[3]];
        }
        Qg(d);
        Og(d, Sg);
        Ng(d, 0);
        ...
        if (8192 >= d.length)
          ...
          for (f = 0; f < d.length; f += 8192)
            e += String.fromCharCode.apply(null, Ua(d, f, f + 8192));
          d = e;
        }
        b += d;
        e = Ta(c, 0, 16);
      ...
      if (null == b)
        ...
        if ("object" == typeof b) {
          ...
          if (b instanceof String || b instanceof Number || b instanceof Boolean)
            ...
            e = "";
            for (d in b)
              Object.prototype.hasOwnProperty.call(b, d) && (f = b[d], "function" != typeof f && (c.push(e), eh(d, c), c.push(":"), ch(a, f, c), e = ","));
            c.push("}");
            return;
          }
        }
    ...
    var fh = { '"': '\\"', "\\": "\\\\", "/": "\\/", "\b": "\\b", "\f": "\\f", "\n": "\\n", "\r": "\\r", "	": "\\t", "\v": "\\u000b" }, gh = /\uffff/.test("￿") ? /[\\"\x00-\x1f\x7f-\uffff]/g : /[\\"\x00-\x1f\x7f-\xff]/g;
    function eh(a, b) {
    ...
    hh.prototype.set = function(a, b) {
      ka(b) ? this.a.set(a, bh(b)) : this.a.ra(a);
    };
    ...
    nh.prototype.ha = function(a) {
      var b = this.g.ha(true), c = this, d = new jb();
      d.next = function() {
    ...
    var qh = new hh(oh), rh = { name: "pendingEmailCredential", storage: qh }, sh = { name: "redirectStatus", storage: qh }, th = { name: "redirectUrl", storage: qh }, uh = { name: "emailForSignIn", storage: new hh(new Ag(3600, "/")) }, vh = { name: "pendingEncryptedCredential", storage: new hh(new Ag(3600, "/")) };
    function wh(a, b) {
    ...
    function $h(a, b) {
      for (var c = 0; c < a.length; c++)
        if (!Ma(ai, a[c]) && (null !== bi && a[c] in bi || Ma(b, a[c])))
          return a[c];
      return null;
    }
    var ai = [
      ...
      "password",
      "phone"
    ], bi = { "facebook.com": "FacebookAuthProvider", "github.com": "GithubAuthProvider", "google.com": "GoogleAuthProvider", password: "EmailAuthProvider", "twitter.com": "TwitterAuthProvider", phone: "PhoneAuthProvider" };
    function ci() {
      this.a = new Ih();
      G(this.a, "acUiConfig");
      G(this.a, "autoUpgradeAnonymousUsers");
      G(this.a, "callbacks");
      G(this.a, "credentialHelper", di);
    ...
    function ki(a) {
      return Ka(gi(a), function(b) {
        if (bi[b.provider] || Ma(li, b.provider)) {
          b = { providerId: b.provider, S: b.providerName || null, V: b.fullLabel || null, ta: b.buttonColor || null, za: b.iconUrl ? Ac(Cc(b.iconUrl)).toString() : null };
          for (var c in b)
            null === b[c] && delete b[c];
          return b;
        }
        return { providerId: b.provider, S: b.providerName || null, V: b.fullLabel || null, ta: b.buttonColor || null, za: b.iconUrl ? Ac(Cc(b.iconUrl)).toString() : null, Ob: b.loginHintKey || null };
      });
    }
    function mi(a) {
    ...
    function yi(a) {
      ...
      if (b) {
        ...
        for (b = 0; b < c.length; b++)
          for (e = Uh(c[b]), d = 0; d < e.length; d++)
            g[e[d].c] = e[d];
        for (e = 0; e < Sh.length; e++)
          null !== g && Sh[e].c in g || a.push(Sh[e]);
      }
      return a;
    }
    function zi(a) {
    ...
    function Ai(a) {
      return (a = hi(a, firebase.auth.EmailAuthProvider.PROVIDER_ID)) && "undefined" !== typeof a.requireDisplayName ? !!a.requireDisplayName : true;
    }
    function Bi(a) {
      a = hi(a, firebase.auth.EmailAuthProvider.PROVIDER_ID);
    ...
    function Di(a) {
      if (Bi(a)) {
        var b = { url: uf(), handleCodeInApp: true };
    ...
    function Ei(a) {
      var b = !!a.a.get("immediateFederatedRedirect"), c = ii(a);
      a = Fi(a);
    ...
    var Li = "accountchooser.com", oi = "googleyolo", di = "none", Mi = { kc: Li, nc: oi, NONE: di }, Gi = "redirect", Hi = { qc: "popup", rc: Gi }, Ni = { mc: "callback", RECOVER_EMAIL: "recoverEmail", sc: "resetPassword", REVERT_SECOND_FACTOR_ADDITION: "revertSecondFactorAddition", tc: "select", uc: "signIn", VERIFY_AND_CHANGE_EMAIL: "verifyAndChangeEmail", VERIFY_EMAIL: "verifyEmail" }, li = ["anonymous"], ri = ["sitekey", "tabindex", "callback", "expired-callback"];
    var Oi, Pi, Qi, Ri, K = {};
    function L(a, b, c, d) {
      K[a].apply(null, Array.prototype.slice.call(
        arguments,
        1
      ));
    }
    ...
    function $i(a, b, c, d, e, f) {
      ...
      switch (a) {
        case 13:
          return ec ? f || e ? false : !(c && d) : true;
        case 27:
          return !(fc || cc || ec);
      }
      return ec && (d || e || f) ? false : Zi(a);
    }
    function Zi(a) {
    ...
    function cj(a) {
      E.call(this);
      this.a = a;
      le(a, "keydown", this.g, false, this);
      le(a, "click", this.h, false, this);
    }
    w(cj, E);
    cj.prototype.g = function(a) {
      (13 == a.keyCode || fc && 3 == a.keyCode) && dj(this, a);
    };
    ...
    cj.prototype.m = function() {
      cj.K.m.call(this);
      te(this.a, "keydown", this.g, false, this);
      te(this.a, "click", this.h, false, this);
      delete this.a;
    };
    function fj(a) {
      $d.call(
    ...
    l.gc = function() {
      if (this.Ka) {
        var a = Aa() - this.j;
        0 < a && a < 0.8 * this.g ? this.aa = this.a.setTimeout(this.h, this.g - a) : (this.aa && (this.a.clearTimeout(this.aa), this.aa = null), ye(this, "tick"), this.Ka && (ij(this), this.start()));
      }
    };
    l.start = function() {
      this.Ka = true;
    ...
    function mj(a, b, c, d) {
      ...
      for (var e = 0; e < c.length; e++) {
        var f = le(b, c[e], d || a.handleEvent, false, a.g || a);
        if (!f)
          break;
        a.a[f.key] = f;
      }
    ...
    oj.prototype.handleEvent = function(a) {
      if ("input" == a.type)
        z && nc(10) && 0 == a.keyCode && 0 == a.j || (pj(this), ye(this, qj(a)));
    ...
    function rj(a, b) {
      E.call(this);
      a && (this.Oa && sj(this), this.qa = a, this.Na = le(this.qa, "keypress", this, b), this.Ya = le(this.qa, "keydown", this.Jb, b, this), this.Oa = le(
        this.qa,
        "keyup",
        this.Kb,
        b,
    ...
    l.X = -1;
    l.Ua = false;
    var tj = { 3: 13, 12: 144, 63232: 38, 63233: 40, 63234: 37, 63235: 39, 63236: 112, 63237: 113, 63238: 114, 63239: 115, 63240: 116, 63241: 117, 63242: 118, 63243: 119, 63244: 120, 63245: 121, 63246: 122, 63247: 123, 63248: 44, 63272: 46, 63273: 36, 63275: 35, 63276: 33, 63277: 34, 63289: 144, 63302: 45 }, uj = {
      Up: 38,
      Down: 40,
      Left: 37,
      Right: 39,
      ...
      PageDown: 34,
      Insert: 45
    }, vj = !fc || nc("525"), wj = hc && ec;
    l = rj.prototype;
    l.Jb = function(a) {
      if (fc || cc) {
        if (17 == this.R && !a.ctrlKey || 18 == this.R && !a.altKey || hc && 91 == this.R && !a.metaKey)
          this.X = this.R = -1;
      }
    ...
    l.handleEvent = function(a) {
      ...
      if (z && "keypress" == a.type) {
        ...
        (fc || cc) && "keypress" == a.type ? (d = this.X, e = 0 <= b.charCode && 63232 > b.charCode && Zi(d) ? b.charCode : 0) : bc && !fc ? (d = this.X, e = Zi(d) ? b.keyCode : 0) : ("keypress" == a.type ? (wj && (c = this.Ua), b.keyCode == b.charCode ? 32 > b.keyCode ? (d = b.keyCode, e = 0) : (d = this.X, e = b.charCode) : (d = b.keyCode || this.X, e = b.charCode || 0)) : (d = b.keyCode || this.X, e = b.charCode || 0), hc && 63 == e && 224 == d && (d = 191));
      var f = d = aj(d);
      d ? 63232 <= d && d in tj ? f = tj[d] : 25 == d && a.shiftKey && (f = 9) : b.keyIdentifier && b.keyIdentifier in uj && (f = uj[b.keyIdentifier]);
      ec && vj && "keypress" == a.type && !$i(f, this.R, a.shiftKey, a.ctrlKey, c, a.metaKey) || (a = f == this.R, this.R = f, b = new xj(f, e, a, b), b.altKey = c, ye(this, b));
    };
    l.N = function() {
      return this.qa;
    };
    ...
    function dk(a) {
      var b = a.message;
      return B(ck({ content: ud('<div class="firebaseui-dialog-icon-wrapper"><div class="' + vd(a.Ma) + ' firebaseui-dialog-icon"></div></div><div class="firebaseui-progress-dialog-message">' + A(b) + "</div>") }));
    }
    ...
    function ek(a) {
      ...
      b = "" + ck({ Ab: D("firebaseui-list-box-dialog"), content: ud(b + "</div>") });
      return B(b);
    }
    ...
    function lk(a, b, c) {
      ...
      if (!c) {
        ...
        if (d) {
          ...
          this.da = function() {
            if (a.open) {
              var f = a.getBoundingClientRect().height, g = d.getBoundingClientRect().height, h = d.getBoundingClientRect().top - document.body.getBoundingClientRect().top, k = d.getBoundingClientRect().left - document.body.getBoundingClientRect().left, p = a.getBoundingClientRect().width, r = d.getBoundingClientRect().width;
    ...
    function mk() {
      var a = nk.call(this);
      a && (jk(a), a.open && a.close(), $c(a), this.da && window.removeEventListener("resize", this.da));
    }
    function nk() {
    ...
    l.v = function() {
      P.K.v.call(this);
      Ce(Q(this), new sk("pageEnter", Q(this), { pageId: this.Ga }));
      if (this.bb() && this.Z.F) {
        var a = this.Z.F;
    ...
    l.ya = function() {
      Ce(Q(this), new sk("pageExit", Q(this), { pageId: this.Ga }));
      P.K.ya.call(this);
    };
    l.m = function() {
    ...
    function tk(a) {
      ...
      a.ca = window.setTimeout(function() {
        a.N() && null === a.A && (a.A = id(fk, { tb: b }, null, a.s), a.N().appendChild(a.A), hk(a.A));
      }, 500);
    }
    ...
    w(Al, R);
    function Bl(a, b, c) {
      R.call(this, Wk, { email: a, G: !!b }, b, c, "verifyAndChangeEmailSuccess");
    }
    w(Bl, R);
    function Cl(a, b) {
      R.call(this, Xk, { G: !!a }, a, b, "verifyAndChangeEmailFailure");
    }
    w(Cl, R);
    function Dl(a, b) {
    ...
    function Ll(a, b, c, d) {
      function e(g) {
        if (!g.name || "cancel" != g.name) {
          ...
          if (p)
            g = Q(b), b.o(), S(a, g, void 0, C("Your sign-in session has expired. Please try again.").toString());
          else {
            p = g && g.message || "";
            if (g.code) {
    ...
    function Nl(a, b) {
      ...
      if (c) {
        ...
        if (rf()) {
          if (!c || c(b, d))
            e = true, Oc(window.opener.location, Pl(a, d));
          c || window.close();
        } else if (!c || c(b, d))
          e = true, Oc(window.location, Pl(a, d));
        e || a.reset();
      } else {
        c = b.user;
        b = b.credential;
        ...
        if (rf()) {
          if (!d || d(c, b, e))
            f = true, Oc(window.opener.location, Pl(a, e));
          d || window.close();
        } else if (!d || d(c, b, e))
          f = true, Oc(window.location, Pl(a, e));
        f || a.reset();
      }
    }
    function Pl(a, b) {
    ...
    function am(a, b, c, d, e, f) {
      c.length || Bi(W(a)) && !Bi(W(a)) ? Ma(c, firebase.auth.EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD) ? L("passwordSignIn", a, b, d, f) : 1 == c.length && c[0] === firebase.auth.EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD ? Bi(W(a)) ? L(
    ...
    function gm(a, b, c) {
      if (c.user) {
        var d = { user: c.user, credential: c.credential, operationType: c.operationType, additionalUserInfo: c.additionalUserInfo }, e = Ah(X(a)), f = e && e.g;
        if (f && !hm(c.user, f))
          im(a, b, d);
        else {
          var g = e && e.a;
    ...
    function lm(a, b, c, d) {
      ...
      V(a, U(a).fetchSignInMethodsForEmail(c).then(function(f) {
        b.o();
        f.length ? Ma(f, firebase.auth.EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD) ? L("passwordLinking", a, e, c) : 1 == f.length && f[0] === firebase.auth.EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD ? L("emailLinkSignInLinking", a, e, c) : (f = $h(f, ii(W(a)))) ? L("federatedLinking", a, e, c, f, d) : (Bh(X(a)), L("unsupportedProvider", a, e, c)) : (Bh(X(a)), L("passwordRecovery", a, e, c, false, Ld().toString()));
      }, function(f) {
        km(a, b, f);
      }));
    }
    ...
    K.callback = function(a, b, c) {
      ...
      V(a, b.then(function(e) {
        ...
        if ((e = Kl(e)) && ("auth/account-exists-with-different-credential" == e.code || "auth/email-already-in-use" == e.code) && e.email && e.credential)
          Ch(new Bg(e.email, e.credential), X(a)), lm(a, d, e.email);
        else if (e && "auth/user-cancelled" == e.code) {
          var f = Ah(X(a)), g = T(e);
          f && f.a ? lm(a, d, f.g, g) : f ? $l(a, d, f.g, g) : km(a, d, e);
        } else
          e && "auth/credential-already-in-use" == e.code || (e && "auth/operation-not-supported-in-this-environment" == e.code && Xl(a) ? gm(a, d, { user: null, credential: null }) : km(a, d, e));
      }));
    };
    function nm(a, b) {
    ...
    function ym(a, b, c, d) {
      "auth/weak-password" == (d && d.code) ? (a = T(d), N(c.i(), false), Oj(c.w(), a), c.i().focus()) : (c && c.o(), c = new Gl(), c.render(b), Y(a, c));
    }
    function zm(a, b, c) {
    ...
    function Fm(a, b, c, d, e) {
      var f = new Em(), g = new Qb(c), h = g.a.a.get(x.$a) || "", k = g.a.a.get(x.Sa) || "", p = "1" === g.a.a.get(x.Qa), r = Tb(g), I = g.a.a.get(x.PROVIDER_ID) || null;
      g = g.a.a.get(x.vb) || null;
      Gm(a, g);
      var Ca = !wh(uh, X(a)), Yk = d || Fh(k, X(a)), ld = (d = Gh(k, X(a))) && d.a;
    ...
    K.emailLinkSignInLinking = function(a, b, c) {
      ...
      Bh(X(a));
      if (d) {
        var e = d.a.providerId, f = new Nm(c, ji(W(a), e), function() {
          Om(a, f, c, d);
        }, H(W(a)), J(W(a)));
        f.render(b);
        Y(a, f);
    ...
    function $m(a, b, c, d) {
      ...
      var f = U(a).fetchSignInMethodsForEmail(c).then(function(g) {
        g.length ? e() : (g = Q(b), b.o(), L("passwordRecovery", a, g, c, false, Ld().toString()));
      }, function() {
        e();
      });
      V(a, f);
    ...
    dn.prototype.v = function() {
      var a = this;
      this.U(this.jb);
      le(this.i, "tick", this.w, false, this);
      this.i.start();
    ...
    dn.prototype.w = function() {
      --this.B;
      0 < this.B ? this.U(this.B) : (ij(this.i), te(this.i, "tick", this.w), this.ua(), this.lb());
    };
    u(dn.prototype, { u: an, pa: bn, Ja: function(a) {
      ...
      var a = Va(Wi(an.call(this)) || "");
      return /^\d{6}$/.test(a) ? a : null;
    }, Fb: cn, U: function(a) {
      ad(cn.call(this), C("Resend code in " + ((9 < a ? "0:" : "0:0") + a)).toString());
    }, ua: function() {
      Nj(this.Fb());
    }, Da: function() {
    ...
    function en(a, b, c, d) {
      ...
      ), V(a, b.I(t(d.confirm, d), [f], function(g) {
        b.h();
    ...
    function jn(a, b, c) {
      var d = this;
      a = id(ek, { items: a }, null, this.s);
      lk.call(this, a, true, true);
      c && (c = kn(a, c)) && (c.focus(), Bj(c, a));
      O(this, a, function(e) {
        if (e = (e = bd(e.target, "firebaseui-id-list-box-dialog-button")) && hn(e, "listboxid"))
          mk.call(d), b(e);
      });
    }
    function kn(a, b) {
    ...
    function qn(a, b, c) {
      var d = Rh(a);
      d && (c && (c = Va(Wi(ln.call(this)) || ""), b = Qh(b, c), b.length && b[0].b != d.b && (c = "+" + d.b + c.substr(b[0].b.length + 1), Xi(ln.call(this), c))), b = Rh(this.Ba), this.Ba = a, a = M(this, "firebaseui-id-country-selector-flag"), b && Vi(a, sn(b)), Ui(a, sn(d)), ad(M(this, "firebaseui-id-country-selector-code"), "‎+" + d.b));
    }
    ...
    u(un.prototype, { Cb: nk, O: ln, B: nn, ea: function(a, b, c) {
      var d = this, e = ln.call(this), f = mn.call(this), g = nn.call(this), h = a || Wh, k = h.a;
      if (0 == k.length)
      ...
      Jj(this, e, function() {
        Pj(g) && (N(e, true), Nj(g));
        var p = Va(Wi(e) || ""), r = Rh(this.Ba), I = Qh(h, p);
        p = pn("1-US-0", k);
      ...
      return b ? new Xh(this.Ba, b) : null;
    }, Ja: mn, ba: function() {
    ...
    K.phoneSignInStart = function(a, b, c, d) {
      ...
      var f = Yl(a), g = xi(W(a)), h = f ? wi(W(a)) : null;
      g = c && c.a || g && g.c || null;
      c = c && c.Aa || h;
      (h = yi(W(a))) && Vh(h);
    ...
    function An(a, b, c, d, e, f, g) {
      P.call(this, Nk, { email: a, yb: c, Eb: !!d }, g, "unauthorizedUser", { F: e, D: f });
      this.l = b;
      this.i = d;
    }
    m(An, P);
    ...
    function Ln(a, b) {
      ...
      if (kh(new lh()) && kh(new mh())) {
        ...
        b = tf(b, "Could not find the FirebaseUI widget element on the page."), f = new Jl(C("The browser you are using does not support Web Storage. Please try again in a different browser.").toString()), f.render(b), Y(a, f);
    ...
    l.ib = function(a) {
      ...
      gc && Jh(b.a, "popupMode", false);
      yi(b);
      !this.da && Ii(W(this)) && (ug("signInSuccess callback is deprecated. Please use signInSuccessWithAuthResult callback instead."), this.da = true);
    };
    function W(a) {
      Z(a);
      return a.ca;
    ...
    l.Wb = function() {
      Z(this);
      var a = W(this), b = Kh(a.a, "widgetUrl");
      a = zi(a);
      var c = b.search(tb);
      for (var d = 0, e, f = []; 0 <= (e = sb(b, d, a, c)); )
    ...
    l.Ib = function(a, b) {
      ...
      var c = this, d = wf();
      if (!Bi(W(this)))
        return ef(Error("Email link sign-in should be enabled to trigger email sending."));
      var e = Di(W(this)), f = new Qb(e.url);
      Rb(f, d);
      b && b.a && (Hh(d, b, X(this)), Ub(f, b.a.providerId));
      Sb(f, Ci(W(this)));
    ...
    function Nn() {
      ...
      if (Jn(a)) {
        a = new Qb(a);
        for (var b in x)
          x.hasOwnProperty(b) && Ob(a.a.a, x[b]);
    ...
    l.bc = function(a, b) {
      Z(this);
      var c = this;
      return U(this).signInWithEmailAndPassword(
        a,
        b
      ).then(function(d) {
        return Gn(c, function(e) {
          return e ? mm(c).then(function() {
            return Hn(c, { code: "auth/email-already-in-use" }, firebase.auth.EmailAuthProvider.credential(a, b));
          }) : d;
        });
      });
    };
    ...
    l.ac = function(a) {
      ...
      return Gn(this, function(c) {
        return c ? c.linkWithCredential(a).then(
          function(d) {
            return d;
          },
          function(d) {
    ...
    function Ol(a, b) {
      Z(a);
      return Gn(a, function(c) {
        if (a.j && !a.j.isAnonymous && ei(W(a)) && !U(a).currentUser)
    ...
    function co(a, b, c) {
      ...
      a = a[b] || a[bo];
      if (!a)
        return pg("Invalid tenant configuration: " + (b + " is not configured!"), void 0), d;
      b = a.signInOptions;
      if (!b)
      ...
      b.forEach(function(e) {
        if ("string" === typeof e)
          ...
          e = "Invalid tenant configuration: signInOption " + (JSON.stringify(e) + " is invalid!"), pg(e, void 0);
      });
      return d;
    }
    function eo(a, b, c) {
        ...
        if (c.a.hasOwnProperty(d)) {
          ...
          if (Wn(c.a[d]) === Vn) {
            ...
            b.forEach(function(r) {
              ...
              if (!I)
                throw Error("Invalid tenant configuration!");
              (I = I[r] || I[bo]) ? r = { tenantId: "_" !== r ? r : null, V: I.fullLabel || null, displayName: I.displayName, za: I.iconUrl, ta: I.buttonColor } : (pg("Invalid tenant configuration: " + (r + " is not configured!"), void 0), r = null);
              r && h.push(r);
            });
            var k = function(r) {
              r = { tenantId: r, providerIds: co(c.a[d], r || "_") };
              e(r);
            };
            if (1 === h.length) {
              k(h[0].tenantId);
            ...
            c.g = new Qn(function() {
              ...
              if (r) {
                for (var I = 0; I < b.length; I++) {
                  ...
                  if (0 !== Ca.length) {
                    r = { tenantId: b[I], providerIds: Ca, email: r };
                    io(c);
                    g && g();
                    e(r);
                    return;
    ...
    l.Zb = function(a, b) {
      ...
      return new We(function(d, e) {
        ...
        e.uiChanged = function(I, Ca) {
          null === I && "callback" === Ca ? ((I = Wc("firebaseui-id-page-callback", c.s)) && Nj(I), c.h = new Tn(), c.h.render(c.s)) : p || null === I && "spinner" === Ca || "blank" === Ca || (c.h && (c.h.o(), c.h = null), p = true, k && k(a.tenantId));
        };
        h.callbacks = e;
    ...
    l.pb = function(a) {
      var b = this, c = Md({ code: a.code }).toString() || a.message;
      io(this);
      var d;
  ...
  }).apply(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : window);
}).apply(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : window);
